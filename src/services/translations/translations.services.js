import { AZURE_TRANSLATION_ENDPOINT, AZURE_TRANSLATION_KEY, AZURE_TRANSLATION_REGION } from '../../config/index.js';

export const translation = async (text) => {
    try {
        const response = await fetch(
            `${AZURE_TRANSLATION_ENDPOINT}/translate?api-version=3.0&from=en&to=uk,ru`, // Исправленный параметр to
            {
                method: "POST",
                headers: {
