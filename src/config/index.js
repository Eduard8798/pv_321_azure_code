...
export const AZURE_TEXT_ANALYTIC_ENDPOINT = process.env.AZURE_TEXT_ANALYTIC_ENDPOINT
export const AZURE_TEXT_ANALYTIC_KEY = process.env.AZURE_TEXT_ANALYTIC_KEY
export const AZURE_TEXT_ANALYTIC_REGION = process.env.AZURE_TEXT_ANALYTIC_REGION
